Quiero mostrarle a todos el proyecto que realize durante el curso que realize con python y django sobre backend en desarollo web , la idea del proyecto es sobre un hotel en lo cual 
cuenta con la pagina principal y que contiene informacion sobre mi , listado del huesped , el registro del huesped , la creacion de cuenta y por ultimo el login basicamente es un 
CRUD O UN ABM !!!!
...
![Image Alt](https://github.com/lucasdanielgonzalez/ServicioHotel-GonzalezLucas/blob/main/nueva-habitacion.png?raw=true)
